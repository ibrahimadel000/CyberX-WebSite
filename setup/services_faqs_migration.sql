-- Services FAQs Migration
-- Adds a faqs JSON column to the services table and seeds FAQ data

ALTER TABLE services ADD COLUMN IF NOT EXISTS faqs JSON DEFAULT NULL AFTER technologies;

-- Seed FAQ data for each service category
UPDATE services SET faqs = '[
...
]' WHERE category_key = 'development';
